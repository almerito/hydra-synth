...
export default () => [
  {
    ...
    wgsl:
      `   return vec4<f32>(vec3<f32>(_noise(vec3<f32>(_st*scale, offset*time))), 1.0);`
  },
  {
    name: 'voronoi',
    type: 'src',
  ...
  },
  {
   ...
   return texture2D(tex, fract(_st));`,
    wgsl:
      `   return textureSample(tex, texSampler, fract(_st));`
  },
  {
    name: 'solid',
    type: 'src',
  ...
  },
  {
    ...
    wgsl:
      `   return textureSample(prevBuffer, texSampler, fract(_st));`
  },
  {
    name: 'sum',
    type: 'color',
